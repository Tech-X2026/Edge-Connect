...
function FloatingOrb({ orb, reducedMotion }: FloatingOrbProps & { reducedMotion: boolean }) {
  return (
    <div
      className={`absolute rounded-full bg-gradient-to-br ${orb.gradient} blur-3xl ${reducedMotion ? '' : 'animate-float-orb'}`}
      style={{
        width: orb.size,
        height: orb.size,
        left: orb.x,
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-ec-dark text-sm font-bold tracking-wider uppercase sm:text-base">
      ...
      >
        ...
        >
          <span className="text-xs font-medium text-ec-muted">Scroll to explore</span>
